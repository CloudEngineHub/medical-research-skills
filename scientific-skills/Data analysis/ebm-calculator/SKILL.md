---
name: ebm-calculator
description: Use ebm calculator for data analysis workflows that need structured execution, explicit assumptions, and clear output boundaries.
license: MIT
skill-author: AIPOCH
---
# EBM Calculator
...
- Use this skill when the task needs Use ebm calculator for data analysis workflows that need structured execution, explicit assumptions, and clear output boundaries.
...
- Scope-focused workflow aligned to: Use ebm calculator for data analysis workflows that need structured execution, explicit assumptions, and clear output boundaries.
...
```bash
cd "20260318/scientific-skills/Data Analytics/ebm-calculator"
