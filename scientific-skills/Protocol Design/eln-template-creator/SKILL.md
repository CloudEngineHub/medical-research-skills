...
description: Generate standardized experiment record templates for Electronic Laboratory Notebooks (ELN).
license: MIT
skill-author: AIPOCH
---
...
- Use this skill when the task is to Generate standardized experiment record templates for Electronic Laboratory Notebooks (ELN).
...
- [references/audit-reference.md](references/audit-reference.md) - Supported ELN template scope, audit commands, and fallback boundaries
...
This skill accepts requests that match the documented purpose of `eln-template-creator` and include enough context to complete the workflow safely.

Do not continue the workflow when the request is out of scope, missing a critical input, or would require unsupported assumptions. Instead respond:

> `eln-template-creator` only handles its documented workflow. Please provide the missing required inputs or switch to a more suitable skill.
