...
- Use this skill when the task needs Build digital twin patient models to test drug efficacy and toxicity.
...
This skill accepts requests that match the documented purpose of `digital-twin-patient-builder` and include enough context to complete the workflow safely.

Do not continue the workflow when the request is out of scope, missing a critical input, or would require unsupported assumptions. Instead respond:

> `digital-twin-patient-builder` only handles its documented workflow. Please provide the missing required inputs or switch to a more suitable skill.

## References

- [references/audit-reference.md](references/audit-reference.md) - Supported simulation scope, audit commands, and fallback boundaries
