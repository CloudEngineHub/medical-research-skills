...
- Flow-cytometry gating workflow planning
- Population hierarchy definition
- Marker and control checkpoint review
...
- the next checks before accepting a final gating strategy
