...
description: Use randomization gen for protocol design workflows that need structured execution, explicit assumptions, and clear output boundaries.
license: MIT
skill-author: AIPOCH
---
# Randomization Gen
...
- Use this skill when the task needs Use randomization gen for protocol design workflows that need structured execution, explicit assumptions, and clear output boundaries.
