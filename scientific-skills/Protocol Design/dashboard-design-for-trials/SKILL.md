...
- Use this skill when the task is to Design dashboard layout sketches for clinical trials showing enrollment.
...
- [references/audit-reference.md](references/audit-reference.md) - Supported dashboard scope, audit commands, and fallback boundaries
...
This skill accepts requests that match the documented purpose of `dashboard-design-for-trials` and include enough context to complete the workflow safely.

Do not continue the workflow when the request is out of scope, missing a critical input, or would require unsupported assumptions. Instead respond:

> `dashboard-design-for-trials` only handles its documented workflow. Please provide the missing required inputs or switch to a more suitable skill.
